...
/* 
    const totalPrice = cartProducts?.map(product => 
        setCheckoutTotal(checkoutTotal + (product.productsInCart.quantity * product.price))
    )
            ...
            <ul className='cart-list'>
                {
                    cartProducts.map(product => (
                        ...
                        </li> /* El navigate se esta propagando al boton de eliminar */
                    ))
                }
            </ul>
